...
export const TOKENS = ["USDT","USDC","ETH","BTC","SOL","TON","MATIC","BNB"] as const;
...
export const MOCK_LINKS = [
  { id:"a7f3k2", title:"Invoice #001 — Design",   amount:"500 USDT",  chain:"ETH",   status:"active",  views:7,  date:"Dec 10" },
  { id:"b8m1p4", title:"Freelance Payment",        amount:"0.05 ETH",  chain:"ETH",   status:"paid",    views:3,  date:"Dec 8"  },
  { id:"c3n7q1", title:"Course Sale",              amount:"100 USDT",  chain:"MATIC", status:"expired", views:1,  date:"Dec 5"  },
  { id:"d9s2r5", title:"Consulting Fee — Q4",      amount:"1.2 SOL",   chain:"SOL",   status:"active",  views:12, date:"Dec 3"  },
];
